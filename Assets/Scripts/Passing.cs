...
public class Passing : MonoBehaviour
{
    ...
    private void Update()
    {
        if (IHaveBall())
        {
            ...
            Debug.DrawRay(transform.position, direction * 10f, Color.black);
    ...
    */
    ...
    {
        var closestAngle = allOtherPlayers.OrderBy(t => Vector3.Angle(direction, DirectionTo(t))).FirstOrDefault();
        return closestAngle;
    }
    private bool IHaveBall() { return transform.childCount > 0; }
